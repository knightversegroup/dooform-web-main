                ...
                <div className="flex flex-col lg:flex-row lg:items-center gap-8 lg:gap-12">
                    ...
                    <div className="flex-1 lg:max-w-[50%]">
                        ...
                        <p className="mt-6 text-body-lg text-text-default">
                            ซัพพลายเออร์ผ้าห่มเยอบีร่าโดนัทโฮสเตส บ๋อยคอนเทนเนอร์วิวตนเอง เทียมทานละตินสตรอว์เบอร์รีรีสอร์ต ผลักดันเซฟตี้แฟล็ตแทคติคมอยส์เจอไรเซอร์ ยูวีเวณิกาพิซซ่าโดนัทโปรดิวเซอร์ แฟรนไชส์ อีสเตอร์แจมโฟน หมายปองไอเดียซากุระกิฟท์ โมเต็ล วินแอโรบิคแรลลี่สคริปต์ เบนโตะโบว์ฮัมยอมรับ โฮสเตสกาญจน์คอมเพล็กซ์เรตติ้งจ๊าบ นิรันดร์งั้น ตุ๊ด งี้ บลูเบอร์รี่พงษ์เวิร์ลด์
                        </p>
                        <div className="mt-8">
