...
export default function HeroBanner({ background = "default" }: HeroBannerProps) {
    ...
    useEffect(() => {
        ...
        const filtered = templates.filter((template) => {
            ...
            return matchesName || matchesDescription || matchesCategory || matchesAuthor;
        });
    ...
    // Popular search tags
    const popularTags = [
        { label: "ใบสมัครงาน", query: "ใบสมัครงาน" },
                    ...
                    <form onSubmit={handleSearch} className="mt-8 w-full max-w-xl relative">
                        <div className="flex items-center bg-background border border-border-default rounded-full overflow-hidden shadow-sm focus-within:border-primary transition-colors">
                            ...
                            <input
                                ...
                                type="text"
                                name="search"
                                placeholder={loading ? "กำลังโหลด..." : "ค้นหาเทมเพลตที่คุณต้องการ..."}
                                value={searchQuery}
